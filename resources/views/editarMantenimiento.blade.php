...
<body>
            ...
            <div class="content-wrapper fade-in">
                ...
                <div class="page-header">
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <a href="{{ route('mantenimientos.show', $mantenimiento->id) }}" class="btn btn-secondary">
                            👁️ Ver Detalles
                        </a>
    ...
    <script>
        ...
        inputs.forEach(input => {
            input.addEventListener('input', function() {
                localStorage.setItem('mantenimiento_edit_' + this.name, this.value);
            });

            // Restaurar datos guardados si existen
            const savedValue = localStorage.getItem('mantenimiento_edit_' + input.name);
        ...
        form.addEventListener('submit', function() {
            inputs.forEach(input => {
                localStorage.removeItem('mantenimiento_edit_' + input.name);
            });
        });
